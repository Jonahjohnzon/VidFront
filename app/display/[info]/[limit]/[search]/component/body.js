...
const router = useRouter()
    const info = Datas?.map((e)=>{
        ...
        return(
            <div className='mb-20 mx-1 2xl:mx-3 '>
            <div key={e._id} className=' 2xl:w-[200px] w-[150px] h-[220px] lg:w-[150px] xl:w-[180px] 3xl:w-[260px] lg:h-[220px] xl:h-[250px] 2xl:h-[300px] 3xl:h-[380px]' onClick={()=>router.push(`/showcase/${e._id}/1`)}>
                <LazyLoadComponent effect="blur"     wrapperProps={{
        // If you need to, you can tweak the effect transition using the wrapper style.
        style: {transitionDelay: "1s"},
    }}>
                <div style={{backgroundImage:`url(${e.image})`}} className=' w-full h-full relative  flex justify-center mb-2 items-center  bg-cover bg-center group sm:cursor-pointer'>
  ...
  return (
    <main>
            ...
            <div className=' flex justify-center w-full '>
                <div className='flex  lg:w-full pb-20   flex-wrap justify-center lg:justify-between '>
                <Data Datas={Datas}/>
                </div>
            </div>
        </div>
